...
const (
	Query_Params_FullMethodName   = "/loyaltychain.loyalty.Query/Params"
	Query_Point_FullMethodName    = "/loyaltychain.loyalty.Query/Point"
	Query_PointAll_FullMethodName = "/loyaltychain.loyalty.Query/PointAll"
)
...
func (c *queryClient) Point(ctx context.Context, in *QueryGetPointRequest, opts ...grpc.CallOption) (*QueryGetPointResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Point_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PointAll(ctx context.Context, in *QueryAllPointRequest, opts ...grpc.CallOption) (*QueryAllPointResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_PointAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) Point(context.Context, *QueryGetPointRequest) (*QueryGetPointResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Point not implemented")
}
func (UnimplementedQueryServer) PointAll(context.Context, *QueryAllPointRequest) (*QueryAllPointResponse, error) {
...
func _Query_Point_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_Point_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_PointAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_PointAll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
